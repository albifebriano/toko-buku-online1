...
<table class="table table-bordered">
	...
	<tr>
		<td><center><?php $data=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * from customer where id_pembeli='$c[id_pembeli]'"));$nama=$data['nama']; echo $nama; ?></center></td>
 		...
 		<td><center>
			<!-- <a href="index.php?page=laporan&act=detail&id=<?php echo $c['id_pembeli']; ?> "><span class="glyphicon glyphicon-eye-open"></span></a>  -->
			 <a href="konfirmasi_transaksi.php?id=<?php echo $c['id_chekout']; ?>&id_pembeli=<?php echo $c['id_pembeli']; ?>"><span class="glyphicon glyphicon-check"></span>Konfirmasi</a></center></td>
	</tr>
	<?php }} ?>
</table>