...
<table class="table table-bordered">
	...
	<tr>
		<td><center><?php $data=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * from buku where id_buku='$c[id_buku]'"));$nama=$data['judul']; echo $nama; ?></center></td>
