    ...
    <nav class="navbar navbar-default navbar-fixed-top" style="background:#d74b35;">
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#" style="color:#fff; font-size:30px;">Hilmi<b>BUKU.pol</b></a>
        </div>
    ...
    <div class="jumbotron">
     ...
     <img src="img/book.jpg">   
      ...
      <div class="col-md-6" style="margin-left:70px;">
        <h2><b>Selamat datang di toko buku murah.<h1>Hilmi<b>BUKU.com</b></h1></h2>
...
<b>Buku Kami</b>
    ...
    <div class="container">
      ...
      <?php
      @$idkat = $_GET['id'] ;
      $qrybukukat = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * from buku where id_ketegori='$idkat'");
      $qrybuku= mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * from buku");
      if($idkat==0){
      ...
      <div style="margin:50px;height:120px;">
        <center>
        <ul>
          <li style="color:#f97b61"><h3><b>Tentang HilmiBUKU</b></h3></li>
        </ul></center>
          <hr>
        <ul>
          <li><b>Hilmi BUKU</b> adalah</li>
      ...
      <div style="margin:50px;height:120px;">
        ...
        <center>&copy; 2023 Karya Hilmi</center>
        </div>
      </div>
  </body>
</html>